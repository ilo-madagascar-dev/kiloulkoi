 ...
 */
final class Version20200512151448 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonces ADD immobilier_id INT DEFAULT NULL, CHANGE vehicule_id vehicule_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE annonces ADD CONSTRAINT FK_CB988C6F5C7B99A9 FOREIGN KEY (immobilier_id) REFERENCES immobilier (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CB988C6F5C7B99A9 ON annonces (immobilier_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_CB988C6F5C7B99A9 ON annonces');
        $this->addSql('ALTER TABLE annonces DROP immobilier_id, CHANGE vehicule_id vehicule_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');

 ...
 */
final class Version20200610063900 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE location CHANGE annonces_id annonce_id INT NOT NULL');
        $this->addSql('ALTER TABLE location ADD CONSTRAINT FK_5E9E89CB8805AB2F FOREIGN KEY (annonce_id) REFERENCES annonces (id)');
        $this->addSql('CREATE INDEX IDX_5E9E89CB8805AB2F ON location (annonce_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_5E9E89CB8805AB2F ON location');
        $this->addSql('ALTER TABLE location CHANGE annonce_id annonces_id INT NOT NULL');

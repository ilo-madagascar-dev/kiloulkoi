 ...
 */
final class Version20200608074056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE location CHANGE location_id annonce_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE location CHANGE annonce_id location_id INT NOT NULL');
